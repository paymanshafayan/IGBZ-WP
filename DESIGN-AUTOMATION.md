...
مرز دقیق پادو، n8n، سرویس مدل و ویرا هنوز تصمیم بعدی فاز ۰۲ است. متن تاریخی این سند دربارهٔ
هم‌مکانی یا مالکیت این چهار جزء تا ثبت ADR بعدی، تصمیم نهایی معماری محسوب نمی‌شود.
