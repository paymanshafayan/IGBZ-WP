		...
		switch ( $tab ) {
				...
				return [
					...
					[
						...
						'options' => [
							...
							'snapppay'  => __( 'SnappPay', 'igbz-suite' ),
							'tara'      => __( 'Tara', 'igbz-suite' ),
						],
					],
			...
			case 'payments':
				return [
					[
						...
						'type'    => 'select',
						'options' => [
							'zarinpal' => __( 'ZarinPal', 'igbz-suite' ),
							'idpay'    => __( 'IDPay', 'igbz-suite' ),
							'nextpay'  => __( 'NextPay', 'igbz-suite' ),
							'payir'    => __( 'Pay.ir', 'igbz-suite' ),
							'httppsp'  => __( 'HTTP PSP', 'igbz-suite' ),
							'nowpayments' => __( 'Crypto (NOWPayments)', 'igbz-suite' ),
							'sadad'       => __( 'Sadad (Melli)', 'igbz-suite' ),
							'asanpardakht' => __( 'Asan Pardakht', 'igbz-suite' ),
							'parsian'     => __( 'Parsian', 'igbz-suite' ),
							'irankish'    => __( 'Iran Kish', 'igbz-suite' ),
							'mellat'      => __( 'Mellat', 'igbz-suite' ),
							'saman'       => __( 'Saman', 'igbz-suite' ),
							'pasargad'    => __( 'Pasargad', 'igbz-suite' ),
							'sepehr'      => __( 'Sepehr', 'igbz-suite' ),
						],
					],
				...
				return [
					...
					[
						...
						'options' => [
							...
							'kavenegar' => __( 'Kavenegar', 'igbz-suite' ),
							'smsir'     => __( 'SMS.ir', 'igbz-suite' ),
						],
					],
			...
			case 'zernio':
				return [
					...
					[ 'key' => 'igbz.publisher_audio', 'label' => __( 'Attach the catalog voice to published posts', 'igbz-suite' ), 'type' => 'checkbox', 'help' => __( 'Off by default (phase 53): a post ships with its image/video only. Turning this on attaches the voice note recorded at product registration to the post, when a real one exists. Missing audio access is a production gate, never a fake.', 'igbz-suite' ) ],
			...
			case 'i18n':
				return [
					...
					[ 'key' => 'i18n.toman_currency', 'label' => __( 'Register the Iranian Toman (IRT) currency', 'igbz-suite' ), 'type' => 'checkbox' ],
					[ 'key' => 'i18n.checkout_base_country', 'label' => __( 'Checkout defaults to the store country for guests and new customers', 'igbz-suite' ), 'type' => 'checkbox' ],
					[ 'key' => 'i18n.persian_front_digits', 'label' => __( 'Persian digits on the storefront', 'igbz-suite' ), 'type' => 'checkbox' ],
			...
			case 'advanced':
				return [
					[
						...
						'type'    => 'select',
						'options' => [
							Logger::DEBUG   => __( 'debug', 'igbz-suite' ),
							Logger::INFO    => __( 'info', 'igbz-suite' ),
							Logger::WARNING => __( 'warning', 'igbz-suite' ),
							Logger::ERROR   => __( 'error', 'igbz-suite' ),
						],
					],
