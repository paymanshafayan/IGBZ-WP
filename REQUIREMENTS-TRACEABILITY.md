...
| UX-002 | RTL، دسترس‌پذیری و نقش‌ها | قانون ویژوال | ۳۵ تصویر | ✅ فاز ۶۸: کشور تسویه مهمان/کاربر=IR (اثبات Store API، مقدار ذخیره‌شده دست‌نخورده) + گلیف ي/ك/ة/ارقام عربی نرمال‌سازی و نیم‌فاصلهٔ محافظه‌کار؛ RTL کامل و ماتریس نقش‌ها در فاز ۶۹ |
