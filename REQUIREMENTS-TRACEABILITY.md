...
| PAD-004 | قالب امن، preview و live tenant-scoped | ADR-0001/0003/0004؛ PADO §۱۸–۲۲ | اسکلت مرجع igbz-store-theme (فاقد PHP/JS/شبکه) + ThemeContract (درگاه سخت‌گیر validate_php_free متصل به ingest) + ThemeValidator/Service (preview/live tenant-scoped از فازهای ۱۵/۱۸) | ✅ نوع ۱ کامل (۶۰)؛ قالب کلاسیک PHP نیازمند خط لولهٔ sandbox/امضا/بازبینی انسانی (ADR-0003 نوع ۲) — اسکیلت آن باقی |
