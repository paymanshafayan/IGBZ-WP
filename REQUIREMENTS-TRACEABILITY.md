...
| PAD-003 | عملیات حساس همگی از صف عبور کنند | ADR-0004؛ DESIGN-LEGAL-AUTH §۷.۷.۵۸ | SensitiveOperationsService (بایند pado.ops): قیمت/refund/حذف انبوه با گیت manage_tenant، هش پیش از اجرا، اجرای قابل جبران، فقط trash؛ SensitiveOpsTest ۱۰ سناریو؛ دود زندهٔ ۱۹گامی + ویژوال | ✅ فاز ۵۸ برای قیمت/refund/حذف انبوه. انتشار/کمپین/سیاست = فاز ۵۹ |
