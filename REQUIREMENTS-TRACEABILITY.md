...
| PAD-004 | قالب امن، preview و live tenant-scoped | ADR-0001/0002؛ PADO §۱۹ | ThemeValidator/Service | شکاف بحرانی: PHP، preview بی‌مصرف، `switch_theme()` سراسری |
...
۸. مرز پادو، n8n، سرویس مدل و ویرا در ADR-0002 بسته شد، ولی متن‌های تاریخی هنوز در فاز
   ۰۳ باید یکدست شوند؛ تعداد نوع خروجی قالب همچنان تصمیم باز فاز ۰۲ است.
