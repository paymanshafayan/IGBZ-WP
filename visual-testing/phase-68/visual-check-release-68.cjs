/* Rule 12 visual check, phase 68: Pado's memory is a backend layer — the visual
   ...
   confirming the fa_IR pack, IRT toman pricing and Persian storefront digits through the real UI surface. */
const fs = require('fs');
...
(async () => {
  ...
  const outDir = '/home/user/IGBZ-WP/visual-testing/phase-68';
