/* Rule 12 visual check, phase 67: Pado's memory is a backend layer — the visual
   ...
   confirming the v48 migration (100/100 tables) through the real UI surface. */
const fs = require('fs');
...
(async () => {
  ...
  const outDir = '/home/user/IGBZ-WP/visual-testing/phase-67';
