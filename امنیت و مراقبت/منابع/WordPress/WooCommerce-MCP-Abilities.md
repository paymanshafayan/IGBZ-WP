...
**بازیابی:** ۱۴۰۵/۰۵/۳۱
**بازبینی جایگاه:** ۱۴۰۵/۰۶/۰۵، فاز ۰۱
**چرا این سند:** کارفرما پرسید «یه تحقیق کن ببین یه پروژه‌ای پیدا می‌کنی که یه مقدار
سبک‌تر بکنه». قابلیت در baseline ووکامرس ۱۱.۰.۱ یافت شد. این منبع اکنون ورودی تصمیم مرز
پادو در فاز ۰۲ و نیازهای PAD-001/SEC-003 در `REQUIREMENTS-TRACEABILITY.md` است؛ فعال‌سازی
MCP هنوز تصمیم قطعی یا شاهد پیاده‌سازی پروژه نیست.
