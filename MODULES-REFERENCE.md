...
**مرز مقصد پادو:** طبق `ADR/ADR-0002-EXTERNAL-PADO-PER-STORE.md` هر زیرسایت حساب پادوی
بیرونی مستقل دارد. ماژول `pado` افزونه فقط adapter اتصال، API ابزار محدود، اعتبارسنج،
preview و مرکز مجوز است؛ runtime عامل/مدل در IGBZ نیست. n8n گردش‌کار قطعی مشترک و ویرا
ابزار داخلی IGBZ است. خروجی طراحی طبق ADR-0003 سه‌گانه است: قالب فرزند بلوکی، قالب
کلاسیک PHP و تمپلیت صفحه‌ساز الحاقی؛ هیچ‌کدام هنوز چرخهٔ کامل پذیرش خود را ندارند. این
مرز نیز در کد فعلی کامل اجرا نشده است.
